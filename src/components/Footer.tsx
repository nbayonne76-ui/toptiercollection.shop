        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/products/home-decor" className="hover:text-white transition-colors">{t('footer.homeDecor')}</Link></li>
              <li><Link href="/products/kitchenware" className="hover:text-white transition-colors">{t('footer.kitchenware')}</Link></li>
              <li><Link href="/products/pet-products" className="hover:text-white transition-colors">{t('footer.petProducts')}</Link></li>
              <li><Link href="/products/beauty-self-care" className="hover:text-white transition-colors">{t('footer.beauty')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/auth/signup" className="hover:text-white transition-colors">{t('nav.signup')}</Link></li>
              <li><Link href="/auth/login" className="hover:text-white transition-colors">{t('nav.login')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/shipping-policy" className="hover:text-white transition-colors">{t('footer.shipping')}</Link></li>
              <li><Link href="/returns-policy" className="hover:text-white transition-colors">{t('footer.returns')}</Link></li>
              <li><Link href="/contact" className="hover:text-white transition-colors">{t('footer.contact')}</Link></li>
            </ul>
            <div className="mt-6">
