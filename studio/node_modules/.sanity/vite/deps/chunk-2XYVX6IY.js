...
import {
  ...
  useToast,
  ut
} from "./chunk-TPMWVCYI.js";
import {
  require_dist
} from "./chunk-TTJVCZIS.js";
import {
  require_jsx_runtime
} from "./chunk-NHE4WBON.js";
import {
  require_react
} from "./chunk-BAK57FXA.js";
import {
  __commonJS,
  __publicField,
  __toESM
} from "./chunk-OJFS7UIV.js";
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-2J4YTWV6.js")
});
...
var VersionModeHeaderLayout = ut.header`
  display: grid;
  grid-area: header;
  grid-template-columns: 1fr min-content 1fr;
  border-block-end: 1px solid var(--card-border-color);
`;
var VersionModeHeaderLayoutSection = ut.div`
  display: flex;
...
`;
var DiffViewPaneLayout = ut(Card)`
  position: relative;
  grid-area: var(--grid-area);
`;
var Container2 = ut(Container)`
  width: auto;
`;
...
var JSONInspectorWrapper = ut.div(({
  theme
}) => {
  const {
    color,
...
var Scroller$4 = ut(ScrollContainer)(({
  $disabled
}) => $disabled ? {
  height: "100%"
} : it`
...
var HorizontalScroller = ut(Card)((props) => {
...
var FlipIcon = ut(ChevronLeftIcon)`
...
var NameSkeleton = ut(Skeleton)((props) => {
  const theme = getTheme_v2(props.theme);
  return it`
    width: 6ch;
...
`;
var SubtleSpinnerIcon = ut(SpinnerIcon)`
  animation: ${rotate} 1500ms linear infinite;
  opacity: 0.4;
`;
var DelayedSubtleSpinnerIcon = ut(SpinnerIcon)`
  animation:
...
`;
var PinnedDataCell = ut(DataCell)`
  position: sticky;
  z-index: 2;
`;
...
`;
var PinnedHeader = ut(Header)`
  position: sticky;
  z-index: 2;
`;
var HoverMenu = ut.div`
  visibility: hidden;
...
var Scroller$3 = ut(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller$2 = ut(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var Scroller$1 = ut(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-2YFBTZLQ.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-2XYVX6IY.js.map
